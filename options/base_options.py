...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='step2',
                            help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--gpu_ids', type=str, default='0, 1', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')

        # model parameters
        parser.add_argument('--model', type=str, default='step2',
                            help='chooses which model to use. [step1 | step2]')
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='srda',
                            help='chooses how datasets are loaded. [srda | single]')
